...
define(["dojo/dom", "dojo/dom-construct", "dojo/window", "dojo/_base/declare","dijit/_WidgetBase", "dijit/_TemplatedMixin", "dojo/text!./ProjectWidget/templates/ProjectWidget.templ", "dojo/dom-style", "dojo/_base/fx", "dojo/_base/lang"],
    function(dom, domConstruct, win, declare, WidgetBase, TemplatedMixin, template, domStyle, baseFx, lang){
        return declare([WidgetBase, TemplatedMixin], {
			...
			postCreate: function(){
				...
				domStyle.set(domNode,"left", (vs.w-this.widthMenu)+"px");
